...
const DEFAULT_SEMANTIC_ROLES: Record<CanvasNodeTypeV2, CanvasCreativeRoleV2> = {
  text: "general_text",
  script: "script",
  image: "general_image",
  video: "general_video",
...
export function createDefaultCanvasNodeRequest(
  ...
  return {
    node_type: nodeType,
    creative_role: DEFAULT_SEMANTIC_ROLES[nodeType],
...
): "general_image" | "general_video" | "bgm" {
  if (mediaType === "image") return "general_image";
  return mediaType === "video" ? "general_video" : "bgm";
}
