...
export function GithubIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path d="M12 2.7a9.3 9.3 0 0 0-2.94 18.12c.46.08.63-.2.63-.44v-1.6c-2.55.55-3.09-1.09-3.09-1.09-.42-1.06-1.02-1.34-1.02-1.34-.84-.57.06-.56.06-.56.92.07 1.41.95 1.41.95.82 1.4 2.15 1 2.67.76.08-.59.32-1 .58-1.23-2.04-.23-4.18-1.02-4.18-4.54 0-1 .36-1.82.95-2.47-.1-.23-.41-1.17.09-2.43 0 0 .77-.25 2.55.94A8.8 8.8 0 0 1 12 6.43c.79 0 1.58.1 2.32.31 1.77-1.19 2.55-.94 2.55-.94.5 1.26.19 2.2.09 2.43.59.65.94 1.47.94 2.47 0 3.53-2.15 4.31-4.2 4.54.33.29.62.85.62 1.71v2.53c0 .24.17.52.64.44A9.3 9.3 0 0 0 12 2.7Z" fill="currentColor" />
    </svg>
  );
}
