...
CONTRACT_MODELS = (
    ...
    agent_canvas_capabilities.ExplicitElementIntentV1,
    agent_canvas_capabilities.TurnIntentDecisionV1,
    agent_canvas_capabilities.TurnIntentContextV1,
    ...
    agent_canvas_capabilities.CapabilityCommandEnvelopeV1,
